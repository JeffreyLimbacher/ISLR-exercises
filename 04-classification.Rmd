...
plot(table(Boston$crim01,Boston$chas),main="Crim01 vs chas")
```
I will compare hand picked variables versus using all of them on train and test sets for all the different methods. I will use accuracy as our error metric since our data is very evenly split.
```{r include=TRUE, echo=TRUE}
train.inds <-sample.int(nrow(Boston)*.6)
...
all.mod <- glm(crim01 ~ ., data=train, family=Binomial)
